...
/**
 * Servicio para gestionar libros en formato PDF. Permite crear, consultar,
 * descargar y eliminar libros PDF mediante solicitudes HTTP.
 */
public class LibroPDFService {
	...
	/**
	 * Envía una solicitud DELETE al backend para eliminar un libro PDF por su
	 * código.
	 *
	 * @param url    URL del endpoint.
