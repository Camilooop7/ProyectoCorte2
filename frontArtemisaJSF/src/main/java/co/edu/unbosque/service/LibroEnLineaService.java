...
/**
 * Servicio encargado de gestionar libros en línea mediante peticiones HTTP al backend.
 * Permite crear, consultar y eliminar libros en línea a través de métodos estáticos.
 */
public class LibroEnLineaService {
    ...
    /**
     * Envía una solicitud DELETE al backend para eliminar un libro en línea por su código.
     *
     * @param url    URL del endpoint.
