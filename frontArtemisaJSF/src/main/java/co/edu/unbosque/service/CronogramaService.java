...
public class CronogramaService {
	...
	/**
	 * Crea un cronograma enviando primero el body como x-www-form-urlencoded. Si el
	 * servidor responde 405/415 (o similar), reintenta con query params.
	 *
	 * Retorna: "statusCode\nbody"
	 */
	public static String crear(String urlCrear, String nombre, String link, String fechaISO) {
		...
		try {
			...
			// Si el backend no acepta body form (405 Method Not Allowed / 415 Unsupported
			// Media Type),
	...
	/**
	 * Lista cronogramas en texto plano. Retorna: "statusCode\nbody"
	 */
