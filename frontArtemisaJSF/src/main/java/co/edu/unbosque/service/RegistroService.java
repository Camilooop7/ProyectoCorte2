...
/**
 * Servicio encargado de registrar estudiantes enviando solicitudes HTTP al backend.
 * Permite crear nuevos estudiantes enviando los parámetros requeridos.
 */
public class RegistroService {
     ...
     * @param rol         Rol del usuario (por ejemplo, "ESTUDIANTE").
     * @param carrera     Carrera del estudiante.
     * @param semestre    Semestre que cursa el estudiante.
